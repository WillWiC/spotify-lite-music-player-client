            ...
            <div key={t.id} className="track-item-dark group">
              <div className="flex items-center">
                <div className="relative mr-3">
                  <img src={t.album?.images?.[0]?.url} alt="cover" className="w-10 h-10 object-cover rounded" />
                  <button 
                    onClick={() => play(t)} 
                ...
                <div className="flex items-center gap-2">
                  <button className="btn-ghost-dark p-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
